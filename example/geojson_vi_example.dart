...
Future<void> main() async {
  ...
  // final geom_line_string =
  //     GeoJSONLineString([pos1, pos2, pos3]);

  // // Create a Feature
  // final feature_line_string = GeoJSONFeature(geometry: geom_line_string);
  ...
  // // Create a Feature
  // final feature_polygon = GeoJSONFeature(geometry: geom_polygon);
